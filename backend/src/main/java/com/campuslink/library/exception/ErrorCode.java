...
public enum ErrorCode {
    ...
    PASSWORD_TOO_WEAK(400, "Mật khẩu quá yếu (phải có ít nhất 8 ký tự, chữ hoa, chữ thường, số)", HttpStatus.BAD_REQUEST),
    ...
    // PAYMENT
    FINE_ALREADY_PAID(409, "Tiền phạt đã được thanh toán trước đó", HttpStatus.CONFLICT),
    PAYMENT_IN_PROGRESS(409, "Đang có giao dịch phạt đang xử lý", HttpStatus.CONFLICT),
    BOOK_PAYMENT_IN_PROGRESS(409, "Đang có giao dịch sách đang xử lý", HttpStatus.CONFLICT),
    NO_FINE_TO_PAY(400, "Không có khoản phạt nào cần thanh toán", HttpStatus.BAD_REQUEST),
    NO_BOOK_TO_PAY(400, "Không có tiền sách nào cần thanh toán", HttpStatus.BAD_REQUEST),
    PAYMENT_NOT_FOUND(404, "Giao dịch không tồn tại", HttpStatus.NOT_FOUND),
    PAYMENT_ALREADY_PAID(409, "Giao dịch đã được thanh toán trước đó", HttpStatus.CONFLICT);
